...
(async function example() {
  ...
  try {
    ...
    // Fill in the form fields with the data.answer value
    const answer = await driver.findElement(By.xpath(`//label[contains(text(), "One or two sentences describing what you do")]//following-sibling::textarea`));
    await answer.sendKeys(data.answer);
